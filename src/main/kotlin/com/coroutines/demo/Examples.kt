...
//Task7 - launch 100k coroutines, in each wait 1s and print a dot
fun main7() = runBlocking {
    //TODO
}

//Global coroutines are like daemon threads
//Task8 - make minimal changes to print "I'm sleeping <number>"
...
suspend fun suspendHere() = suspendCancellableCoroutine<String> {
    ...
    class Examples(override val coroutineContext: CoroutineContext) : CoroutineScope {
...
//Hot publisher - (e.g. defer()) might start publishing data right away and would continue doing so whenever a new Subscriber comes in
        ...
        companion object {
            ...
            fun main(args: Array<String>) {
                val mono = Examples(EmptyCoroutineContext).main100()
